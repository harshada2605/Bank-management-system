...
public class PinChange extends JFrame implements ActionListener {
    ...
    PinChange(String pinnumber) {
        ...
        pintext.setBounds(200, 280, 700, 35);
        image.add(pintext);
        
        pin = new JPasswordField();
        pin.setFont(new Font("Raleway", Font.BOLD, 25));
        pin.setBounds(280, 280, 110, 25);
        image.add(pin);
        ...
        repintext.setBounds(200, 330, 700, 25);
        image.add(repintext);
        
        repin = new JPasswordField();
        repin.setFont(new Font("Raleway", Font.BOLD, 35));
        repin.setBounds(350, 330, 100, 25);
        image.add(repin);
        
        change = new JButton("CHANGE");
        change.setBounds(280, 385, 150, 30);
        change.addActionListener(this);
        image.add(change);
        
        back = new JButton("BACK");
        back.setBounds(280, 420, 150, 30);

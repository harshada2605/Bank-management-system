...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno) {
        ...
        l1.setBounds(200, 40, 250, 40);
        add(l1);
        
        JLabel type = new JLabel("Account Type:");
        type.setFont(new Font("Raleway", Font.BOLD, 22));
        type.setBounds(100, 100, 160, 30);
        add(type);
        
        r1 = new JRadioButton("Savings Account");
        r1.setFont(new Font("Raleway", Font.BOLD, 16));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100, 150, 180, 20);
        add(r1);
        ...
        card.setBounds(100, 220, 300, 30);
        add(card);
        
        JLabel number = new JLabel("XXXX-XXXX-XXXX-4287");
        ...
        services.setBounds(100, 330, 200, 20);
        add(services);
        ...
        submit.setBounds(250, 510, 100, 30);
        ...
        cancel.setBounds(420, 510, 100, 30);
        submit.addActionListener(this);
        add(cancel);
